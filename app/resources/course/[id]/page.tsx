...
export default function CoursePage({
  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--text-muted)]">
                Lesson {currentLesson + 1} of {lessons.length} · {course.duration}
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Course header extras */}
      <div className="max-w-4xl mx-auto px-4 pb-4 -mt-4">
        {/* YouTube & Methods */}
        <div className="flex flex-wrap items-start gap-3 mb-4">
          ...
          {course.benefits.slice(0, 2).map((b, i) => (
            <span key={i} className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs bg-[var(--primary)]/10 text-[var(--primary)]">
              ✓ {b}
            </span>
          ))}
        </div>
        ...
        {/* Methods list */}
        <details className="bg-[var(--surface)] rounded-xl border border-[var(--surface-hover)]">
          <summary className="px-4 py-3 cursor-pointer text-sm font-medium text-[var(--text-primary)] hover:text-[var(--primary)]">
